...
namespace FacetedSearch.BusinessLogic
{
    ...
    public class SearchManager
    {
        ...
        //public static SearchResultData SearchEntry(string SearchTerm, int page, Dictionary<string, string> filters, int _pageSize, int _maxResults)
        //{
        ...
        //        { "language", "language"},
        //        { "country", "country"},
        //        { "modifier", "userLastModified"},
        //        { "hall", "hall"},
        //        { "booth", "booth"},
        //        { "branches", "branches"},
        //        { "components", "components"},
        //        { "machinetype", "machineType"},
        //        { "status", "bookletEntryStatus"},
        ...
        //    //Check range filter.
        //    List<QueryContainer> rangeQueryList = new List<QueryContainer>();
        //    if (filters.ContainsKey("dateRange_createBigger"))
        //    {
        //        rangeQueryList.Add(Query<BookletEntry>.Range(r => r.OnField("timestampCreated").Greater(DateTime.Parse(filters["dateRange_createBigger"]).AddDays(1), "yyyy-MM-dd")));
        //    }
        //    if (filters.ContainsKey("dateRange_createLower"))
        //    {
        //        rangeQueryList.Add(Query<BookletEntry>.Range(r => r.OnField("timestampCreated").Lower(DateTime.Parse(filters["dateRange_createLower"]), "yyyy-MM-dd")));
        //    }

        //    if (filters.ContainsKey("dateRange_editBigger"))
        //    {
        //        rangeQueryList.Add(Query<BookletEntry>.Range(r => r.OnField("timestampLastModified").Greater(DateTime.Parse(filters["dateRange_editBigger"]).AddDays(1), "yyyy-MM-dd")));
        //    }

        //    if (filters.ContainsKey("dateRange_editLower"))
        //    {
        //        rangeQueryList.Add(Query<BookletEntry>.Range(r => r.OnField("timestampLastModified").Lower(DateTime.Parse(filters["dateRange_editLower"]), "yyyy-MM-dd")));
        //    }
        ...
        //    {
        //        searchQueryList.Add(Query<BookletEntry>.Prefix("_all", strText)); // Wortanfang genügt, bei ganzen Wörtern .Term anstatt .Prefix verwenden!
        //    }
        ...
        //                                            .Query(fqa => fqa.Bool(b => b.Must(rangeQueryList.ToArray())))
        ...
        //                                   );
        //    //  .Terms("exhibitor1", c => c.Aggregations(u => u.Filter("greater", z => z.Filter(q => q.Range(m => m.LowerOrEquals(c.Field(f => f.TimestampCreated), "dd-MM-yyy'T'HH:mm:ss"))))))
